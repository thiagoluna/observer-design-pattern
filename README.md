...
This project is an example of a practical application of the Observer Design Pattern.  
In the implemented example, we have the case of other services should do something when the price is updated.  
The Observer Design Pattern is a behavioral design pattern that allows a class to notify other classes when its state changes.
